...
float T_set = 30.5; //set Temperature in C degree
//PID Parameters
...
void loop() {
  ...
  err = (Tshield[0]+Tshield[1]+Tshield[2]+Tshield[3]+Tshield[4]+Tshield[5])/6.0-T_set;
  if(isnan(err)){
  ...
  TreadingBuf[0],TreadingBuf[1],TreadingBuf[12],TreadingBuf[13],
